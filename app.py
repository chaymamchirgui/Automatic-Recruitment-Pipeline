     ...
     try: 
        for i in spredsheet.sheet.row_values(j):
            if(i=='Applied'):
                ...
                msg = Message("hi",sender = 'user@gmail.com')
        ...
        break   
    #confirmation mail
    msg = Message("confirmation Mail",sender ='user@gmail.com',recipients=['user@gmail.com'])
    mail.send(msg)
    #return "message is sent to route"
    return ("message is sent")
 except:
    # error mail
    msg = Message("bug Mail",sender ='user@gmail.com',recipients=['user@gmail.com'])
    mail.send(msg) 
